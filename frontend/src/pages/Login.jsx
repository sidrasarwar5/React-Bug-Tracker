            ...
            <div className="rounded-4xl border border-white/70 bg-white/80 p-8 shadow-2xl shadow-slate-200/50 backdrop-blur xl:p-10">
              <div className="mb-8 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Access your QA, developer, or manager workspace securely.
                </p>
              </div>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600">
                  Authorized access only. Your session is protected for
                  project workflow security and role-based access.
                </div>
